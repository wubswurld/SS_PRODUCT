...
class MobileTeamPage extends Component {
    render() {
        return (
            ...
            <hr></hr>
                    <div className="row">
                        <div className="col-md-4 col-sm-4">
                            <div className="team-member">
                                <div className="team-img">
                                    <img src="34463580.jpeg" alt="team member" className="img-responsive" id="peliot"></img>
                                </div>
                        ...
                        <div className="col-md-4 col-sm-4">
                            <div className="team-member">
                                <div className="team-img">
                                    <img src="20190509_180135.jpg" alt="team member" className="img-responsive" id="wub"></img>
                                </div>
                                <div className="team-hover">
                                    <div className="desk">
                                        <p> I specialize in Front-end and Back-end Web app creation. I focus on the front-end designs for out team with over two years of coding experience in languages such as C, Node.js React, Js and Jquery. I will provide a finished product that keeps up with 2019 trends.</p>
                                    </div>
                                    <div className="s-link">
